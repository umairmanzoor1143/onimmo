...
const ColorChangeCards = () => {
  return (
    <div className="p-4 py-12 md:p-8">
      <div className="mx-auto grid w-full max-w-6xl grid-cols-3 gap-4 md:gap-8">
        <Card
          heading="Play"
...
const Card = ({ heading, description, imgSrc }: CardProps) => {
  return (
    <motion.div
      ...
      whileHover="hover"
      className="group relative h-94 w-full cursor-pointer overflow-hidden bg-slate-300 rounded-xl"
    >
